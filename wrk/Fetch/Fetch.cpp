// Fetch.cpp : アプリケーションのエントリ ポイントを定義します。
//
...
wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	::LoadStringW(hInstance, IDC_FETCH, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_FETCH));
	MSG 	msg;
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_FETCH);
